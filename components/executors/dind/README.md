...
> deploy via [Terraform](https://sourcegraph.com/docs/self-hosted/executors/deploy-executors-terraform)
> or [binary](https://sourcegraph.com/docs/self-hosted/executors/deploy-executors-binary).

Executors are Sourcegraph’s solution for running untrusted code in a secure and controllable way. For more information on dind executors and how they are used see the Executors [dind documentation](https://sourcegraph.com/docs/self-hosted/executors/deploy-executors-dind)
